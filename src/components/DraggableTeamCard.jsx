...
/**
 * Draggable TeamCard component for displaying team information and combinations input
 * @param {Object} props
 ...
 */
export function DraggableTeamCard({ team, combinations, teamIndex, allCombinations = [], isCustom = false, onCombinationsChange, disabled }) {
  ...
  return (
    <Card ref={setNodeRef} style={style} sx={{ cursor: isDragging ? 'grabbing' : 'grab' }}>
      <CardContent sx={{ p: 2 }}>
